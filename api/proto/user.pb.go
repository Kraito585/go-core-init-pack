...
const file_api_proto_user_proto_rawDesc = "" +
	...
	"\vUserService\x126\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x15.user.GetUserResponseB\x1aZ\x18my-service/pkg/api/protob\x06proto3"
...
var file_api_proto_user_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
